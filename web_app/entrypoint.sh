...
echo "server {
    ...
    error_page 404 /app/templates/custom404.html;
    location = /app/templates/custom404.html {
        internal;
    }
    error_page  500 502 503 504 /app/templates/custom500.html;
    location = /app/templates/custom500.html {
        internal;
